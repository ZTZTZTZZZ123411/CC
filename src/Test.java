...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		IplImage imgA = cvLoadImage("BlackBalls.jpg", CV_LOAD_IMAGE_GRAYSCALE);
		IplImage imgB = cvLoadImage("Blob1.jpg", CV_LOAD_IMAGE_GRAYSCALE);
		...
		IplImage imgC = cvLoadImage("Blob2.jpg", CV_LOAD_IMAGE_UNCHANGED);
